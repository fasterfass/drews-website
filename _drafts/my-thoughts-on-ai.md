---
layout: single
title: "My Philosophical Thoughts on AI"
author: Drew Fass
date: 2026-04-16
...
<!-- Introduction:
    1. Talk about noise and confusion around AI
    2. Talk about speed at which AI is growing and seeping into every portion of our lives
    3. Talk about the desire to better understand how this transformative technology will impact us on an individual and societal level
    4. Lead into the big picture (or individual-based lens first)

Big Picture:
    1. What is Capitalism? (balance between labor and capital)
    2. AI fundamentally shifts the balance
        - Less reliance on labor, more power for capital to squeeze more efficiency out of labor or to make labor obsolete altogether via the fact that AI can automate the previously-human only skills by synthesizing "context" and "knowledge" to make complex decisions and complete complex actions. 
        - Lose-lose proposition for labor, either a race to the bottom (with limited leverage, use Jevon's paradox) or a career reset
        - Most people are labor, not capital
    3. Changes in the labor 🤝 capital agreement starts to break the social contract most people rely on for both meaning and survival
        - Prior social contract: if you do x, you get y (ex: if you go to college, you will have a job postgrad / if you buy a house, that house will go up in value and be worth putting on debt due to the promise of a more lucrative tomorrow / if you play in the system, you will be rewarded with stable outcomes)
        - AI threatens this social contract due to the combination of the cost of goods and services climbing while capital relies on labor less an less
        - Foundational cracks in this agreement (in the US) lead to many negative externalities on a societal level: economic disruption → identity collapse (due to a shift in human value in the workforce) → loss of trust → power vacuums → leads to a scarcity or abundance economy → either way redefines the value of money and what it can be used for
        - Details for specific buckets:
            - Human Value
                1. What is human value in an AI-driven economy? (we are fallable, have limited attention spans and limited memory, and have our own ingrained biases -- where does that fit into the AI value curve?)
                2. How do we collectively decouple from the work-driven identity many of us possess, as our value relative to AI in that skill degrades?
            - Identity
                1. When individual identities built on work-derived meaning begin to collapse, negative externalities generally occur (think opioid epidemic + the US auto market offshoring). 
                2. People struggle with change, especially change that happens quickly and erodes the security of their current setup. There will likely be pushback in the short term even if AI is benefitial to society in the long run (this I think it the most likely outcome).
            - Money
                1. What is the value of money in an AI-driven economy where either:
                    - Abundance becomes possible (excess supply drives cost of goods to effectively zero) OR 
                    - Scarcity becomes worse due to a small subset of the population (capital) increasing control over limited resources (K shaped economy on steroids, rise of financial nihilism, universal basic income, etc.)
                2. The choice of abundance vs scarcity is ours. We can point innovation in any direction via legislative carrots and sticks - choose wisely. Personally abundance > scarcity helps the majority of the population.
                3. Examples of artificial or forced scarcity:
                    - Oil via Iran War (forced)
                    - Tarriffs to inflate the price of foreign goods (forced)
                    - Housing crisis due to NIMBY-ism (artificial)
                    - University enrollment slots (artificial)
            - Power / Perception of Reality
                1. Control of information can lead to the distortion of information and the augmenting of reality. Those with the microphone can augment reality and sway public opinion for those relying on the message.
                    - This problem already exists, but is potentially exasterbated by AI systems that are less deterministic in their answers and have the potential to hallucinate.
                    - Just like prior tools, AI can be used to augment reality and sway public opinion as it becomes a window for the average person to interface with the world. 
                2. Corporate profit incentives often outweigh collective health and sanity.
                    - Algorithm-driven social media has been leveraged to sway public perception to sell goods and win elections.
                    - Companies like meta, instagram, and tiktok have built their platforms to purposefully be addictive in favor of profit over societal health. We have proof that these tools fracture attention spans while increasing the rates of anxiety, depression, and suicide amidst their user base. It also lowers our collective capacity to understand trends and combat weaponized information and tools, making our society dumber.
                3. AI agents actively synthesize and personalize narratives at scale
                    - Writes your narrative for you outside of your control
                    
            - Societal Instability / Loss of Collective Trust in Humanity
                1. Societal instability collectively leads to less trust in institutions
                2. Less trust in instituations leads to more identity-driven politics (in-group, out-group) instead of collective cooperation. 
                3. Most of humanity's growth historically is built on the back of communal trust (hunter/gatherers working together to hunt larger animals to feed the tribe, various countries post-WWII working together to prioritize peace and cooperation over war, etc.). Humanity works best when there is a communal story that everyone buys into and works together within towards a common goal. AI doesn't provide a common goal as of right now.

Individual Picture (me):
    1. My industry, software engineering, is being squeezed
        - Offshorting + AI are leading to either a race to the bottom in search of endless "efficiency" OR an automating of humans out of the loop (less engineers needed to do the same amount of work).
        - New college graduates struggling to find jobs right now, big tech continuing to lay off employees due to AI automation, AI models continuing to progress against coding benchmarks, token price continuing to fall
        - Sentiment is currently on the side of AI "winning". Things will normalize over time (and we have no idea what "winning" will actually look like). I think it's possible there are more software engineers employed in the future than there are today, but I think it will take a few years to normalize and shift out of the current game.
    2. What types of games should I play in an AI centric world?
        - Enable deeper work over shallow task completion
            - Fractured attention spans reduce our capacity for deep thought and deep work which will become more valuable as the world becomes more complex (increased thruput of work will increase the complexity of existing systems and problems)
            - Prioritize roles that value depth
            - Deep work gives more flexibility in terms of your ability to pivot if needed.
        - Health is the new wealth
            - Given the unknowns of the AI boom, continue to prioritize health over all else. Being healthy with the ability to do deep work will give you an edge regardless of where things go in the future.
            - Financial value is relative to what it can buy you. Nothing is more valuable than your time. Additionally, the spectrum of where we land between a world of abundance or a world of scarcity in the future will have a large impact of the true value of any saved $$$.
            - If you enjoy your role, keep playing it. But ensure you aren't letting your health slip as a result 
        - Let others race to the bottom in the efficiency game. Provide value in the ability to cut through complexity that will naturaly build up over time.
            - The value is not in the automation itself, it's in the systems thinking that enables holistic modeling how to achieve the meta-level outcome you're looking for. 
            - Reference https://www.drewfass.com/my-thoughts/2026/04/10/simplicity-is-king.html 
        - Human-centric games and liability-focused games will not be automated away
            - People pay lawyers primarily to help them mitigate liability and offload risk onto a more knowledgable party. They pay consultants for the same thing (so they can have plausable deniability and someone to point to if a project doesn't complete on time). This is not an efficiency-driven game, and thus AI doesn't threaten this career path in the same way it does to software engineers.
            - Human-centric games (like being a nurse, a teacher, or a therapist) provide value via the human element, and thus are not going to be automated away. In these roles people connect with other people, not with the efficiency of how fast they can do a task (for the most part).
    3. How can I decouple my identity and value from my work?
        - Reference https://www.drewfass.com/philosophical/2026/02/18/a-new-philosophy-on-life.html 
        - Investing in New Places
            - Creativity & Happiness over Productivity
            - Autonomy & Security over Dependence
            - Mindset & Awareness over Fear
    4. What now?
        - Summarize the next steps holistically joining your thoughts on potential games, health implications, financial impliciations, and the human element. Keep this focused on the individual.

Holistic Takeaways:
    1. We have the power to collectively decide our future
        - Human Value
            Give offramps for people within careers that will be automated away. Lower the financial bar for people to retrain by going back to school (and create incentives for them to do so in under-staffed industries). Create unions to give labor more leverage in the short-term while the transition is underway. Emphasize a shift in knowledge work from task-completion to systems thinking (see Complexity is King 👑)
        - Identity
            More 3rd spaces where people can interact in the real world instead of in the digital one. More enforcement against grifters trying to pull people into scams off of their fear of missing out and their fear of not being enough. Less identity driven politics (in-group vs. out-group, us vs. them), more empathy and kindness for those still finding their way.
        - Money
            Everyone needs to have financial upside benefit for AI to not exasterbate societal unrest. If money is going to continue to be what we use to denote value, we need to be more inclusive to ensure the floor (baseline) is high enough for people to thrive. This is possible by choosing abundance (increasing supply to reduce price) over artificial or forced scarcity (reducing supply due to disagreements or to artificially inflate prices).
        - Power / Perception of Reality
            Make information and knowledge ubiquitous without a financial incentive to warp the narrative for profit by removing the pay-for-attention advertizing business model. Promote the well-being of the society over the financial well-being of corporations by creating clearer boundaries for companies to operate within.
        - Societal Instability / Loss of Collective Trust in Humanity
            Trust is built slowly over time by having expectations (of what you say) match reality (of what you do). As such, we need more accountability to connect the dots between expectations and reality if we want more collective trust.
    2. All eras have their own existential risks. This is a new type of problem, but the concept of societal shifts are not novel. 
    3. Short term bearish (lots of instability, loss of work/identity/etc, poor incentive alignment with long term future). Long term bullish (the productivity boost is real, the ubiquity of knowledge and information can be leveraged to level-up our understanding of the world, better tools than ever before to solve the problems we face collectively). -->
...
- Biological AI models like [AlphaFold](https://deepmind.google/blog/alphafold-using-ai-for-scientific-discovery-2020/) have leveled up our ability to predict protein structures, which provide a better baseline for understanding how viruses and drugs interact with one another at a molecular level. These breakthroughs have helped us discover new drugs and breakdown novel viruses, including decyphering the infamous SARS-CoV2 spike protein from the 2020 Covid pandemic to allow for vaccine rollout at record speed.
...
Abundance provides a more level playing field for everyone to operate within. Less power games. Less extrinsic hurdles to achieve. More potential for people to live lives more aligned with their personal goals and desires. It [simplifies](https://www.drewfass.com/my-thoughts/2026/04/10/simplicity-is-king.html) our collective ability to provide a level playing field for everyone. AI, if it continues to advance at it's current pace, has the potential to enable this future for all of us.
...
The costs of these data centers is substantial. To put it in perspective, over the next 5 years or so there is an estimated [~$5T](https://www.goldmansachs.com/insights/articles/tracking-trillions-the-assumptions-shaping-scale-of-the-ai-build-out) being dumped into these AI data center projects. That's enough investment to prop up the US economy. If we remove the AI data center investment from the economy, we would've been in a [recession](https://fortune.com/2025/10/07/data-centers-gdp-growth-zero-first-half-2025-jason-furman-harvard-economist/) in the first half of 2025 according to Fed reports on US GDP. To make things more volatile, the Fed GDP report from 2025 doesn't take into account the recent price increases of materials and trade due to tariffs and war in the middle east. Prices of building materials and shipping is climbing at a point where demand is outstripping supply, thus leading to inflated construction costs and [substantial data center project delays and full project cancellations](https://www.datacenterknowledge.com/energy-power-supply/why-ai-data-center-projects-face-years-of-delays-after-approval). At this point in time, about half of the new data center projects have been cancelled or delayed.
...
To help you grasp the sheer scale of these training runs, every foundational AI model (Gemini, GPT, Claude, etc) individually uses around [10^26 floating-point operations (FLOPs)](https://epoch.ai/data/ai-models?view=graph&tab=large-scale) of compute per training cycle. That's 100 septillion operations run on AI chips to build a single model! That's a large enough number that it is roughly on par with the number of stars in the universe (if multiplied by 1 million) or 1.3 million Earth's worth of sand (if every FLOP equated to a single grain). Put another way, if every person on Earth today (8 billion people) did one math calculation every second, it would take the entire human race 400 million years to do the same number of calculations that AI chips do in just months on a single training cycle... insane.

And this is all for a single instance of a single frontier model (of which we have many)! Compound this with the fact that AI compute seems to be doubling every 7 months, it's easy to see how the models will continue to grow in size and cost until we [may not have enough compute on Earth](https://epoch.ai/blog/model-counts-compute-thresholds) to run them... which highlights why AI data centers are such a big deal. 

Ok. I get it. Why does that matter?

It matters because the AI spend is heavily outpacing AI profits on the other side of the balance sheet and the AI economy is relying heavily on debt and IOUs to fill the gap. This by itself isn't a concern - lots of companies and governments at every level use debt to help fund projects today on the promise of benefits tomorrow ([Amazon](https://letters.ehoneahobed.com/the-1-7-trillion-paradox-how-amazon-turned-20-years-of-losses-into-the-ultimate-victory-78a6ca26dc3d) and [Uber](https://doctorow.medium.com/no-ubers-still-not-profitable-2b8054e375ea) are both famous for leveraging debt to capture market share). But this level of debt, at this scale and this speed is unprecedented in history. 

For some context, OpenAI (largely considered one of the leaders in the space), currently loses tens of billions of dollars every year and makes a majority of it's revenue through its subscription business. It's currently [monitizing less than 5%](https://medium.com/write-a-catalyst/0-3-of-the-world-pays-for-ai-and-6-billion-dont-know-what-it-is-7e903900df71) of it's user base, has turned off Sora (it's video generation platform), has faced public backlash due to its backroom deals with the Department of War, and has turned on ads in an effort to make money after Sam Altman [explicitly said they would not do so except as a last resort](https://www.reddit.com/r/artificial/comments/1qf9thi/i_kind_of_think_of_ads_as_like_a_last_resort_for/). Since it's a private company, we don't have access to it's balance sheet, but OpenAI is on record saying that it will not only turn a profit but one at ["Nvidia-level scale"](https://finance.yahoo.com/markets/stocks/articles/openai-reportedly-set-file-ipo-181332424.html?guccounter=1&guce_referrer=aHR0cHM6Ly93d3cuZ29vZ2xlLmNvbS8&guce_referrer_sig=AQAAAL8aDhhW8qKiDl4AIef-7AW_ZB1JO0D99G--bFvbHHq8yN3sLXnBRjkmngwVTnWGmQxgubWblL2JKODJU3zIASoNMstYax5PhDu1Z773RUijzBeqls0kJk4kWf75Oe7GEM_EVk6NJQOte-136tGXQoMTQssiymd6pki-OmW1dNkg) by 2029. There is no way to know if that will be true, but based on the current financials it's not a leap to say that they are making promises they can't keep. 

OpenAI is only one of many AI model companies (Google, Meta, Anthropic, etc...) and is the most egregious example of leaning on debt-based promises they are unlikely to keep, but the industry as a whole is universally selling AI at a loss today. If AI companies eventually experience a funding squeeze (which is possible given the recessionary environment we are in outside of AI data center buildout spend), it's plausable they'll eventually have to change their pricing structure in an attempt to pull in more revenue to offset growing costs. Just this past month, GitHub Copilot announced they are moving to a [usage based pricing plan](https://github.blog/news-insights/company-news/github-copilot-is-moving-to-usage-based-billing/) where instead of paying for a subscription you pay per AI inference invocation. This is just one example of how market dynamics may push prices of AI services up over time, thus changing the value prop of when to use AI models and how often to use them. Given that fact most of the AI financing is banking on AI revenue going up exponentially over time, a lowering in demand via the rollout of less subsidized pricing models could counteract this narrative and underwhelm investors.
...
<insert AI circular financing photo>
...
As per Bloomberg's article (linked above^) the problem with circular financing is that it compounds risk if the AI demand doesn't meet expectations. Instead of a single entity failing (and all others making out relatively unscathed), in a circular ecosystem where everyone is dependent on each other, everyone would suffer from a single link in the chain going under. This is important to note as some links in this AI funding chain are more risky than others. While some chip providers in this chart are printing money hand over fist (Nvidia made ~$80B in revenue per quarter in 2025), other entities like OpenAI are actively losing tens of billions per year while in a hyper-competitive market and having to default to last resort tactics like ads to keep the financials solvent (see section above for more info). It's possible this circle has gotten too big to fail, and thus it could be bailed out by an IPO or a government bailout, but regardless the circular financing model is adding risk across the economy on the backs of an asymmetric bet that may not come true.

Lastly, given the huge economic and power incentives at play, there have been some reports that the accounting behind the AI boom isn't always honest about the current financial situation. One example of this is the logic behind the [depreciation of older models](https://www.youtube.com/watch?v=Z2ljcpT_xhs) of AI chips. Due to the speed of the AI race, new chips regularly come out making the old models obsolete increasingly quickly. As new chips roll out older ones are no longer as valuable on the bleeding edge of AI and thus have a limited use case relative to their previous value. To account for this, AI companies often depreciate AI chip assets on their quarterly earnings reports to spread the cost of those chips out over ~5-6 years of use. This helps buffer the cost in any given year thereby inflating profits in the short term at the expense of future gains. In reality, even though AI companies are claiming use of these chips for ~5-6 years, there is evidence that they are only truly valuable for [~2-3 years](https://www.wsj.com/finance/investing/the-accounting-uproar-over-how-fast-an-ai-chip-depreciates-6f59785b) and thus by spreading out the loss AI companies can clean up their books and boost their stock price in the short term to cover the gap. It's a relatively small problem relative to the circular financing and general AI debt bubble discussed above, but shows proof of how the narrative may not always be as rock solid as it seems.


3. **Job Market Impacts:**


4. **Fudging the Numbers to Mislead Investors:**


## Circular AI Financing


## Half-Baked AI Product Launches


## Legacy AI Chip Depreciation Fudging
